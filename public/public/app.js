...
function downloadResultAsImage() {
    ...
    // Remove animation temporarily so html2canvas doesn't capture it at opacity 0
    const oldAnimation = resultsSec.style.animation;
    resultsSec.style.animation = 'none';
    ...
    html2canvas(resultsSec, {
        ...
        resultsSec.style.animation = oldAnimation;
